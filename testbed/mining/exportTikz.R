if (length(find.package("tikzDevice", quiet = TRUE))) {
  ...
  export_graph(
    ...
    plots.nb_deployed.w,
    plots.nb_deployed.h,
    plots.nb_deployed.caption
  )
  export_graph(
    "./respected_sla.tex",
    plots.respected_sla,
    plots.respected_sla.w,
    plots.respected_sla.h,
    plots.respected_sla.caption
  )
  ...
  export_graph(
    ...
    plots.spending.w,
    plots.spending.h,
    plots.spending.caption
  )
  export_graph(
    "./deploymenttimes.tex",
    plots.deploymenttimes,
    plots.deploymenttimes.w,
    plots.deploymenttimes.h,
    plots.deploymenttimes.caption
  )
