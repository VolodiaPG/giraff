...
METRICS_ARKS <- c(
  ...
  # "metrics_valuation_rates.env_1_1726576574-fog_node-auction-quadratic_rates-no_complication-market-default_strategy-.env.1_2024-09-17-13-27.tar.xz",
  # "metrics_valuation_rates.env_1_1726576574-fog_node-edge_furthest-quadratic_rates-no_complication-market-default_strategy-.env.1_2024-09-17-13-51.tar.xz",
  # "metrics_valuation_rates.env_1_1726576574-fog_node-edge_ward-quadratic_rates-no_complication-market-default_strategy-.env.1_2024-09-17-14-17.tar.xz",
  # "metrics_valuation_rates.env_1_1726576574-fog_node-mincpurandom-quadratic_rates-no_complication-market-mincpurandom-.env.1_2024-09-17-13-04.tar.xz",
  # "metrics_valuation_rates.env_1_1726664782-fog_node-edge_furthest-quadratic_rates-no_complication-market-default_strategy-.env.1_2024-09-18-14-48.tar.xz",
  # "metrics_valuation_rates.env_1_1726664782-fog_node-edge_ward-quadratic_rates-no_complication-market-default_strategy-.env.1_2024-09-18-14-00.tar.xz",
