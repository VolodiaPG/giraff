              ...
              pythonPackagesExtensions =
                ...
                ++ [
                  (python-final: python-prev: {
                    ...
                    ansible = python-prev.ansible.overridePythonAttrs (old: rec {
                      version = "8.7.0";
                    ...
                    ansible-core =
                      (python-prev.ansible-core.overridePythonAttrs (old: rec {
                        version = "2.14.15";
                        src = prev.fetchPypi {
                          inherit (old) pname;
                          inherit version;
                      ...
                      {inherit (python-final) ansible;};
                  })
                ];
              experiments = final.python3.withPackages (
                ps: (with ps; [
                  dill
                  click
                  types-click
          ...
          system: let
            ...
            basis = pkgs.dockerTools.buildImage {
              ...
              runAsRoot = ''
                ...
                mkdir -p /tmp
                mkdir -p /usr/bin
                ln -s ${pkgs.toybox}/bin/env /usr/bin/env
              '';
            };
