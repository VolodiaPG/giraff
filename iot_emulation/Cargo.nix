...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".actix-web-opentelemetry."0.13.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" then "actix_http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-http."3.2.2" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" then "actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-web."4.2.1" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" then "futures_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" then "opentelemetry_semantic_conventions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-semantic-conventions."0.10.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.139" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.66" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing") "default")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing") "std")
    ];
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "proc_macro2" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.40" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "quote" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.20" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "syn" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.98" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".crossbeam-channel."0.5.6" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "cfg_if" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "crossbeam_utils" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.8.14" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".futures."0.3.21" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "alloc")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "async-await")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "default")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "executor")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "futures-executor")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "std")
    ];
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_channel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_io" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-io."0.3.25" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_sink" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-sink."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_task" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-task."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.21" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.21" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      [ "alloc" ]
      [ "default" ]
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "futures-sink")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "sink")
      [ "std" ]
    ];
    dependencies = {
      futures_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.21" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.21" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_task" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-task."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.21" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.21" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      [ "alloc" ]
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") "async-await")
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") "async-await-macro")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "channel")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "futures-channel")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "futures-io")
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") "futures-macro")
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") "futures-sink")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "io")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "memchr")
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") "sink")
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") "slab")
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") "std")
    ];
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_channel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.21" { inherit profileName; };
      futures_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_io" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-io."0.3.25" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_macro" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-macro."0.3.21" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_sink" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-sink."0.3.21" { inherit profileName; };
      futures_task = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-task."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "memchr" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memchr."2.5.0" { inherit profileName; };
      pin_project_lite = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.9" { inherit profileName; };
      pin_utils = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-utils."0.1.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "slab" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".slab."0.4.6" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".headers."0.3.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "base64" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.13.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "bitflags" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.3.2" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "bytes" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.3.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "headers_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".headers-core."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "httpdate" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".httpdate."1.0.2" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "mime" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.16" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "sha1" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".sha1."0.10.5" { inherit profileName; };
    };
  });
  ...
  "unknown".iot_emulation."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" then "actix_web_opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-web-opentelemetry."0.13.0" { inherit profileName; };
      ...
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.14.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "opentelemetry_jaeger" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "reqwest_tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.139" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.82" { inherit profileName; };
      tokio = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.20.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "tracing_actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-actix-web."0.7.2" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "tracing_opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "mime" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.16" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "unicase" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" { inherit profileName; };
    };
    buildDependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "unicase" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "opentelemetry_api" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "opentelemetry_sdk" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry_sdk."0.18.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-http."0.7.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "bytes" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.3.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "opentelemetry_api" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.11" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "headers" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".headers."0.3.8" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "opentelemetry_http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-http."0.7.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "opentelemetry_semantic_conventions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-semantic-conventions."0.10.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.11" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.37" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "thrift" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thrift."0.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.20.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-semantic-conventions."0.10.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "fnv" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".fnv."1.0.7" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_channel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "indexmap" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.9.1" { inherit profileName; };
      ${ if (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry") && hostPlatform.parsed.cpu.name == "wasm32" then "js_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.58" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "pin_project_lite" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.9" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.37" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry_sdk."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "crossbeam_channel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-channel."0.5.6" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "dashmap" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".dashmap."5.4.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "fnv" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".fnv."1.0.7" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_channel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "futures_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "opentelemetry_api" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "percent_encoding" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".percent-encoding."2.1.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "rand" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.8.5" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.37" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.20.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "tokio_stream" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-stream."0.1.11" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ordered-float."1.1.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "num_traits" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num-traits."0.2.15" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pin-project."1.0.12" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "pin_project_internal" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-internal."1.0.12" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pin-project-internal."1.0.12" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "proc_macro2" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.40" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "quote" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.20" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "syn" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.98" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.11" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      [ "hyper-tls" ]
      [ "json" ]
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing") "mime_guess")
      (lib.optional (rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing") "multipart")
      [ "native-tls-crate" ]
      [ "serde_json" ]
      [ "tokio-native-tls" ]
      [ "tokio-util" ]
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "mime_guess" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.4" { inherit profileName; };
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "tokio_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-util."0.7.3" { inherit profileName; };
      tower_service = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tower-service."0.3.2" { inherit profileName; };
      url = rustPackages."registry+https://github.com/rust-lang/crates.io-index".url."2.2.2" { inherit profileName; };
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "wasm_bindgen" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen."0.2.81" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "anyhow" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.66" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.11" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.139" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "task_local_extensions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.37" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.11" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "task_local_extensions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "tracing_opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.20.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".threadpool."1.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "num_cpus" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.14.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".thrift."0.16.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "byteorder" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".byteorder."1.4.3" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "integer_encoding" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".integer-encoding."3.0.4" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.17" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "ordered_float" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ordered-float."1.1.1" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "threadpool" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".threadpool."1.8.1" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tokio-stream."0.1.11" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "default")
      (lib.optional (rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger") "time")
    ];
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "futures_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.21" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "pin_project_lite" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.9" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/actix-web-opentelemetry" || rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/opentelemetry" || rootFeatures' ? "iot_emulation/opentelemetry-jaeger" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.20.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing-actix-web."0.7.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-web."4.2.1" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "pin_project" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project."1.0.12" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "tracing_opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/tracing-actix-web" then "uuid" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".uuid."1.1.2" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "tracing_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-core."0.1.30" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "tracing_log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-log."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-tracing" || rootFeatures' ? "iot_emulation/tracing-actix-web" || rootFeatures' ? "iot_emulation/tracing-opentelemetry" then "tracing_subscriber" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-subscriber."0.3.16" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "iot_emulation/jaeger" || rootFeatures' ? "iot_emulation/reqwest-middleware" || rootFeatures' ? "iot_emulation/reqwest-tracing" then "version_check" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".version_check."0.9.4" { profileName = "__noProfile"; };
    };
  });
