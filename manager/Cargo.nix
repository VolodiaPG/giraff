...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".actix-web-opentelemetry."0.13.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.13.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "aaa592a5b9b3d96101434bca1024c6da6c23630163aec485428e613cd7100dcf"; };
    dependencies = {
      actix_http = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-http."3.2.2" { inherit profileName; };
  ...
  "unknown".fog_node."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      (lib.optional (rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware") "reqwest-middleware")
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" then "opentelemetry_jaeger" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" then "reqwest_tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" { inherit profileName; };
      ...
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.149" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.89" { inherit profileName; };
      serde_with = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_with."2.1.0" { inherit profileName; };
      thiserror = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.37" { inherit profileName; };
      tokio = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.23.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-actix-web" then "tracing_actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-actix-web."0.7.2" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-opentelemetry" then "tracing_opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".headers."0.3.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "base64" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.13.1" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "bitflags" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.3.2" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "bytes" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.3.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "headers_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".headers-core."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "httpdate" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".httpdate."1.0.2" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "mime" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.16" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "sha1" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".sha1."0.10.5" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".hyper-openssl."0.9.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      once_cell = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.16.0" { inherit profileName; };
      openssl = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl."0.10.44" { inherit profileName; };
      openssl_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.79" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".json-patch."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.3.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e712e62827c382a77b87f590532febb1f8b2fdbc3eefa1ee37fe7281687075ef"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "diff" ]
      [ "treediff" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".k8s-openapi."0.17.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.17.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3d1985030683a2bac402cbda61222195de80d3f66b4c87ab56e5fea379bd98c3"; };
    features = builtins.concatLists [
      [ "api" ]
      [ "default" ]
      [ "http" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".kube."0.78.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.78.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "53ee2ba94546e32a5aef943e5831c6ac25592ff8dcfa8b2a06e0aaea90c69188"; };
    features = builtins.concatLists [
      [ "client" ]
      [ "config" ]
      [ "default" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".kube-client."0.78.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.78.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7c9ca1f597bd48ed26f45f601bf2fa3aaa0933b8d1652d883b8444519b72af4a"; };
    features = builtins.concatLists [
      [ "__non_core" ]
      [ "base64" ]
      [ "bytes" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".kube-core."0.78.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.78.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "61f2c6d1a2d1584859499eb05a41c5a44713818041621fa7515cfdbdf4769ea7"; };
    features = builtins.concatLists [
      [ "json-patch" ]
      [ "jsonpatch" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".kube-runtime."0.78.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.78.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7995aaf15656bf3694cd455578d59119acc3ca55f71e9a1b579a34a47d17ecce"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libmimalloc-sys."0.1.28" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.1.28";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "04d1c67deb83e6b75fa4fe3309e09cfeade12e7721d95322af500d3814ea60c9"; };
    dependencies = {
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.138" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "unknown".market."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      (lib.optional (rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware") "reqwest-middleware")
    ...
    dependencies = {
      ...
      mimalloc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mimalloc."0.1.32" { inherit profileName; };
      model = rustPackages."unknown".model."0.1.0" { inherit profileName; };
      ${ if rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "opentelemetry_jaeger" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" { inherit profileName; };
      prometheus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".prometheus."0.13.3" { inherit profileName; };
      reqwest = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" { inherit profileName; };
      ${ if rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" then "reqwest_tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" { inherit profileName; };
      ron = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ron."0.8.0" { inherit profileName; };
      schemars = rustPackages."registry+https://github.com/rust-lang/crates.io-index".schemars."0.8.11" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.149" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.89" { inherit profileName; };
      ...
      tokio = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.23.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-actix-web" then "tracing_actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-actix-web."0.7.2" { inherit profileName; };
      tracing_appender = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-appender."0.2.2" { inherit profileName; };
      tracing_forest = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-forest."0.1.5" { inherit profileName; };
      tracing_log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-log."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-opentelemetry" then "tracing_opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
      tracing_subscriber = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-subscriber."0.3.16" { inherit profileName; };
      uom = rustPackages."registry+https://github.com/rust-lang/crates.io-index".uom."0.33.0" { inherit profileName; };
      uuid = rustPackages."registry+https://github.com/rust-lang/crates.io-index".uuid."1.2.2" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mimalloc."0.1.32" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.1.32";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "9b2374e2999959a7b583e1811a1ddbf1d3a4b9496eceb9746f1192a59d871eca"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "mime" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.16" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "unicase" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" { inherit profileName; };
    };
    buildDependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "unicase" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".native-tls."0.2.11" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.kernel.name == "windows" || hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "openssl" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl."0.10.44" { inherit profileName; };
      ...
      ${ if !(hostPlatform.parsed.kernel.name == "windows" || hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.79" { inherit profileName; };
  ...
  "unknown".openfaas."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      (lib.optional (rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware") "reqwest-middleware")
    ...
    dependencies = {
      ...
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.17" { inherit profileName; };
      reqwest = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" { inherit profileName; };
      ${ if rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "reqwest_tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" { inherit profileName; };
      ron = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ron."0.8.0" { inherit profileName; };
      schemars = rustPackages."registry+https://github.com/rust-lang/crates.io-index".schemars."0.8.11" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.149" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.89" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl."0.10.44" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ffi = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.79" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-http."0.7.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "bytes" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.3.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "opentelemetry_api" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.25" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "futures_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.25" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "headers" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".headers."0.3.8" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "opentelemetry_http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-http."0.7.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "opentelemetry_semantic_conventions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-semantic-conventions."0.10.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.37" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "thrift" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thrift."0.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.23.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "fnv" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".fnv."1.0.7" { inherit profileName; };
      futures_channel = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.25" { inherit profileName; };
      futures_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.25" { inherit profileName; };
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.9.2" { inherit profileName; };
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "js_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.60" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry_sdk."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "dashmap" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".dashmap."5.4.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "fnv" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".fnv."1.0.7" { inherit profileName; };
      futures_channel = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.25" { inherit profileName; };
      futures_executor = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.25" { inherit profileName; };
      futures_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.25" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ordered-float."1.1.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "num_traits" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num-traits."0.2.15" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      [ "hyper-tls" ]
      [ "json" ]
      (lib.optional (rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing") "mime_guess")
      (lib.optional (rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing") "multipart")
      [ "native-tls-crate" ]
      [ "serde_json" ]
      [ "tokio-native-tls" ]
      [ "tokio-util" ]
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "ipnet" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ipnet."2.6.0" { inherit profileName; };
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "js_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.60" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "mime_guess" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.4" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4a1c03e9011a8c59716ad13115550469e081e2e9892656b0ba6a47c907921894"; };
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "anyhow" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.66" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.8" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.149" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "task_local_extensions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.37" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.4.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b739d87a6b2cf4743968ad2b4cef648fbe0204c19999509824425babb2097bce"; };
    features = builtins.concatLists [
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.59" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "task_local_extensions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "tracing_opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".serde_with."2.1.0" = overridableMkRustCrate (profileName: rec {
    name = "serde_with";
    version = "2.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "25bf4a5a814902cd1014dbccfa4d4560fb8432c779471e96e035602519f82eef"; };
    features = builtins.concatLists [
      [ "alloc" ]
      [ "default" ]
      [ "macros" ]
    ...
    dependencies = {
      ...
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.149" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.89" { inherit profileName; };
      serde_with_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_with_macros."2.1.0" { profileName = "__noProfile"; };
      time_0_3 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".time."0.3.17" { inherit profileName; };
    };
  });

  "registry+https://github.com/rust-lang/crates.io-index".serde_with_macros."2.1.0" = overridableMkRustCrate (profileName: rec {
    name = "serde_with_macros";
    version = "2.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e3452b4c0f6c1e357f73fdb87cd1efabaa12acf328c7a528e252893baeb3f4aa"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.23.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".threadpool."1.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "num_cpus" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.14.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".thrift."0.16.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "byteorder" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".byteorder."1.4.3" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "integer_encoding" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".integer-encoding."3.0.4" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.17" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "ordered_float" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ordered-float."1.1.1" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/opentelemetry-jaeger" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/opentelemetry-jaeger" then "threadpool" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".threadpool."1.8.1" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing-actix-web."0.7.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-actix-web" then "actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-web."4.2.1" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-actix-web" then "opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-actix-web" then "pin_project" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project."1.0.12" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-actix-web" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-actix-web" then "tracing_opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/tracing-actix-web" then "uuid" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".uuid."1.2.2" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "tracing_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-core."0.1.30" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "tracing_log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-log."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "fog_node/tracing-actix-web" || rootFeatures' ? "fog_node/tracing-opentelemetry" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "market/tracing-actix-web" || rootFeatures' ? "market/tracing-opentelemetry" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-tracing" then "tracing_subscriber" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-subscriber."0.3.16" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "fog_node/jaeger" || rootFeatures' ? "fog_node/reqwest-middleware" || rootFeatures' ? "fog_node/reqwest-tracing" || rootFeatures' ? "market/jaeger" || rootFeatures' ? "market/reqwest-middleware" || rootFeatures' ? "market/reqwest-tracing" || rootFeatures' ? "openfaas/jaeger" || rootFeatures' ? "openfaas/reqwest-middleware" || rootFeatures' ? "openfaas/reqwest-tracing" then "version_check" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".version_check."0.9.4" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".zstd-sys."2.0.4+zstd.1.5.2" = overridableMkRustCrate (profileName: rec {
    ...
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4fa202f2ef00074143e219d15b62ffc317d17cc33909feac471c044087cad7b0"; };
    features = builtins.concatLists [
      [ "legacy" ]
      [ "std" ]
      [ "zdict_builder" ]
