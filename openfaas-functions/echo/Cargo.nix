...
in
{
  ...
  "unknown".echo."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "opentelemetry_jaeger" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "reqwest_tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.152" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.94" { inherit profileName; };
      tokio = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.26.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "tracing_actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-actix-web."0.7.2" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-opentelemetry" then "tracing_opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".futures."0.3.26" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_channel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_io" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-io."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_sink" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-sink."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_task" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-task."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.26" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.26" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      futures_sink = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-sink."0.3.26" { inherit profileName; };
      futures_task = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-task."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "memchr" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memchr."2.5.0" { inherit profileName; };
      pin_project_lite = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.9" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".headers."0.3.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "base64" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.13.1" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "bitflags" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.3.2" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "bytes" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.4.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "headers_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".headers-core."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.9" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "httpdate" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".httpdate."1.0.2" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "mime" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.16" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "sha1" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".sha1."0.10.5" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".lazy-regex."2.4.1" = overridableMkRustCrate (profileName: rec {
    ...
    version = "2.4.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a505da2f89befd87ab425d252795f0f285e100b43e7d22d29528df3d9a576793"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "mime" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.16" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "unicase" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" { inherit profileName; };
    };
    buildDependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "unicase" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-http."0.7.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.66" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "bytes" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.4.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.9" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "opentelemetry_api" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.14" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.66" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "futures_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.26" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "headers" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".headers."0.3.8" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.9" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.17.1" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "opentelemetry_http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-http."0.7.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "opentelemetry_semantic_conventions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry-semantic-conventions."0.10.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.14" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.39" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "thrift" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thrift."0.16.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.26.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "fnv" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".fnv."1.0.7" { inherit profileName; };
      futures_channel = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.26" { inherit profileName; };
      futures_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.26" { inherit profileName; };
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.9.2" { inherit profileName; };
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "js_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.61" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry_sdk."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "dashmap" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".dashmap."5.4.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "fnv" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".fnv."1.0.7" { inherit profileName; };
      futures_channel = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.26" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ordered-float."1.1.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "num_traits" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num-traits."0.2.15" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pin-project."1.0.12" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "pin_project_internal" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-internal."1.0.12" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pin-project-internal."1.0.12" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "proc_macro2" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.51" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "quote" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.23" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "syn" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.109" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.14" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "mime_guess" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.4" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "anyhow" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.69" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.66" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.9" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.14" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.152" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "task_local_extensions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.39" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest-tracing."0.4.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.66" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.14" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "reqwest_middleware" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest-middleware."0.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "task_local_extensions" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" then "tracing_opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".task-local-extensions."0.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.26.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".threadpool."1.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "num_cpus" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.15.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".thrift."0.16.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "byteorder" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".byteorder."1.4.3" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "integer_encoding" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".integer-encoding."3.0.4" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.17" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "ordered_float" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ordered-float."1.1.1" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/opentelemetry-jaeger" then "threadpool" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".threadpool."1.8.1" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing-actix-web."0.7.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "actix_web" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-web."4.3.1" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "pin_project" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project."1.0.12" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "tracing_opentelemetry_0_18_pkg" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/tracing-actix-web" then "uuid" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".uuid."1.3.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing-opentelemetry."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.17.1" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "opentelemetry" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opentelemetry."0.18.0" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "tracing" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "tracing_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-core."0.1.30" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "tracing_log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-log."0.1.3" { inherit profileName; };
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-tracing" || rootFeatures' ? "echo/tracing-actix-web" || rootFeatures' ? "echo/tracing-opentelemetry" then "tracing_subscriber" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-subscriber."0.3.16" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".unicase."2.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "echo/jaeger" || rootFeatures' ? "echo/reqwest-middleware" || rootFeatures' ? "echo/reqwest-tracing" then "version_check" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".version_check."0.9.4" { profileName = "__noProfile"; };
    };
  });
